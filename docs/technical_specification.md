...
2. **Raw values are never printed in a description this package generates.** Not truncated, not masked, absent. This is a hard guarantee, verified by tests. It scopes to generated text; rule 4 covers the one description the package does not write.
